...
window.loadDraft = function() {
    ...
    if (draftStr) {
        try {
            ...
            setTimeout(() => window.executeAiAllocation(), 400); 
...
window.saveSqSchedule = function() {
    ...
    document.getElementById('schedule-quick-modal').classList.add('hidden'); window.saveAllocationPlan(); 
};
