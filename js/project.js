...
window.getFilteredProjects = function() {
    ...
    if(window.currentMonthFilter) { 
        list = list.filter(item => { 
            ...
            return sEst.startsWith(window.currentMonthFilter) || sEn.startsWith(window.currentMonthFilter) || 
                   aEst.startsWith(window.currentMonthFilter) || aEn.startsWith(window.currentMonthFilter); 
        }); 
    }
