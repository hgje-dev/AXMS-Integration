...
// 🌟 철통 방어 1: 과거 데이터의 날짜, 숫자, 객체 오류 원천 차단
...
// 무조건 문자로 변환하여 .replace(), .startsWith() 에러 방지
const getSafeString = (val) => String(val || '');
